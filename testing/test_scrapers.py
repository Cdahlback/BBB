...
class TestIndVarScrapers(unittest.TestCase):
    def test_url_contains_email(self):
        html = BeautifulSoup('<html><body><a href="mailto:test@example.com">Test Email</a></body></html>',
                                      'html.parser')
    ...
    def test_contains_reviews_page(self):
        ...
        html = BeautifulSoup('<html><body><a href="https://example.com/reviews">Reviews</a></body></html>',
                             'html.parser')
        self.assertTrue(contains_reviews_page(html))

        # Test case where reviews page is not found
        html = BeautifulSoup('<html><body><a href="https://example.com/about">About Us</a></body></html>',
                             'html.parser')
    ...
    def test_contains_social_media_links(self):
        ...
        html = BeautifulSoup('''<html><head><title>Sample Page</title></head>
                    <body>
    ...
    def test_contains_contacts_page(self):
        ...
        html = BeautifulSoup('<html><body><a href="contact">Contact Us</a></body></html>', 'html.parser')
        ...
        html = BeautifulSoup('<html><body><a href="about">About Us</a></body></html>', 'html.parser')
